    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span
            className="animate-on-scroll opacity-0 translate-y-6 transition-all duration-700 inline-flex items-center px-4 py-2 rounded-full border border-[#A8D4C8]/60 bg-[#F0F7F4] text-sm font-semibold text-[#5A9686] uppercase tracking-[0.12em] shadow-sm"
          >
